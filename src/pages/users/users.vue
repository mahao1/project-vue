	...
	export default({
		...
		data() {
			return {
				...
				comments: [{
					username: "张三",
					userimg: "/static/images/car1.jpg",
					...
					username: "李四",
					userimg: "/static/images/car2.jpg",
					words: "吃饭去了啊。呵呵！",
					like: 23,
					nolike: 63,
					...
					username: "王五",
					userimg: "/static/images/car3.jpg",
					words: "这评论可以。呵呵！",
					like: 27,
					nolike: 33,
			...
			register: function() {
				...
				if(!flag) {
					if(username == "" || psw == "") {
						...
						//随机生成头像
						var randomImg = "/static/images/car" + randomNum + ".jpg";
